...
const SkillAssessment: NextPage = () => {
    ...
    return (
        <PageWrapper title={`Gama leveling`} theme="gamaAcademy" lightNavbar>
            <h2 hidden>{`Work`}</h2>
            <ProjectCover
                title={`Gama leveling`}
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                >
                                    <Box component="figure">
                                        <Box
                                            component="img"
                                            src="/images/projects/gama-leveling/mapping-personas.png"
                                            sx={{
                                                mb: 1,
                                                width: '100%',
                                                maxWidth: 401,
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        <Box component="figure">
                                            <Box
                                                component="img"
                                                src="/images/projects/gama-leveling/benchmarking-analysis.png"
                                                sx={{
                                                    mb: 1,
                                                    width: '100%',
                                                    maxWidth: 256,
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                >
                                    <Box component="figure">
                                        <Box
                                            component="img"
                                            src="/images/projects/gama-leveling/alignment-diagram.png"
                                            sx={{
                                                mb: 1,
                                                width: '100%',
                                                maxWidth: 332,
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        <Box component="figure">
                                            <Box
                                                component="img"
                                                src="/images/projects/gama-leveling/inverted-pyramid.png"
                                                sx={{
                                                    mb: 1,
                                                    width: '100%',
                                                    maxWidth: 474,
                                        ...
                                        <Grid container spacing={2} justifyContent="center">
                                            <Grid item xs={12} md={4}>
                                                <Box component="figure">
                                                    <Box
                                                        component="img"
                                                        src="/images/projects/gama-leveling/landing-page-mid-fidelity.png"
                                                        sx={{
                                                            mb: 1,
                                                            width: '100%',
                                                            maxWidth: 272,
                                            ...
                                            <Grid item xs={12} md={4}>
                                                <Box component="figure">
                                                    <Box
                                                        component="img"
                                                        src="/images/projects/gama-leveling/landing-page-high-fidelity.png"
                                                        sx={{
                                                            mb: 1,
                                                            width: '100%',
                                                            maxWidth: 266,
                                            ...
                                            <Grid item xs={12} md={4}>
                                                <Box component="figure">
                                                    <Box
                                                        component="img"
                                                        src="/images/projects/gama-leveling/landing-page-high-fidelity-w-adjustments.png"
                                                        sx={{
                                                            mb: 1,
                                                            width: '100%',
                                                            maxWidth: 268,
                                        ...
                                        <Grid container spacing={1} justifyContent="center">
                                            <Grid item xs={12} md={4}>
                                                <Box component="figure">
                                                    <Box
                                                        component="img"
                                                        src="/images/projects/gama-leveling/choose-stack.png"
                                                        sx={{
                                                            mb: 1,
                                                            width: '100%',
                                                            maxWidth: 326,
                                            ...
                                            <Grid item xs={12} md={4}>
                                                <Box component="figure">
                                                    <Box
                                                        component="img"
                                                        src="/images/projects/gama-leveling/instructions.png"
                                                        sx={{
                                                            mb: 1,
                                                            width: '100%',
                                                            maxWidth: 326,
                                            ...
                                            <Grid item xs={12} md={4}>
                                                <Box component="figure">
                                                    <Box
                                                        component="img"
                                                        src="/images/projects/gama-leveling/test.png"
                                                        sx={{
                                                            mb: 1,
                                                            width: '100%',
                                                            maxWidth: 326,
                                            ...
                                            <Grid item xs={12} md={4}>
                                                <Box component="figure">
                                                    <Box
                                                        component="img"
                                                        src="/images/projects/gama-leveling/test-results.png"
                                                        sx={{
                                                            mb: 1,
                                                            width: '100%',
                                                            maxWidth: 326,
                                            ...
                                            <Grid item xs={12} md={4}>
                                                <Box component="figure">
                                                    <Box
                                                        component="img"
                                                        src="/images/projects/gama-leveling/activity-panel.png"
                                                        sx={{
                                                            mb: 1,
                                                            width: '100%',
                                                            maxWidth: 326,
                                    ...
                                    <Stack spacing={2}>
                                        ...
                                        <Stack spacing={2}>
                                            ...
                                            <Link
                                                ...
                                                variant="body1"
                                                fontWeight={500}
                                                href="/documents/usability-test-feedbacks.pdf"
                                                target="_blank"
                                                underline="hover"
                                            >
